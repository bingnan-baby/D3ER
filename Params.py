...
def ParseArgs():
	...
	parser.add_argument("--maxd_v", type=float, default=200, help="distance threshold of visual-shared and visual-specific features")
	parser.add_argument("--maxd_t", type=float, default=1.5, help="distance threshold of text-shared and text-specific features") #
